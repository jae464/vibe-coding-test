          ...
          <div className="flex-1 overflow-hidden">
            {activeTab === 'problem' && (
              <div className="p-4 h-full overflow-y-auto">
                {problem ? (
                  <div>
                    <h3 className="text-lg font-semibold mb-4">{problem.title}</h3>
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-gray-50 p-3 rounded-md">
                          ...
                          <p className="text-sm text-gray-600">{problem.timeLimit}ms</p>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-md">
                          <h4 className="font-medium mb-1">메모리 제한</h4>
                          <p className="text-sm text-gray-600">{problem.memoryLimit}MB</p>
                        </div>
                      </div>
                    </div>
                  </div>
